...
router.get('/', function(req, res, next) {
  res.render('work', { title: 'How We Help | Services', bodyClass: 'projects', shortTitle: 'Success stories', description: 'Lessons from our client success stories', layout: 'default' });
});
